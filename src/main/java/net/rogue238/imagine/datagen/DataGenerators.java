...
import net.rogue238.imagine.worldgen.tree.ModWorldGenProvider;

import java.util.concurrent.CompletableFuture;

@Mod.EventBusSubscriber(modid = Imaginative_biomes.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
